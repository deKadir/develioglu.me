...
function App() {
  ...
  return (
    <div className="bg-primary">
      ...
      <div
        id="container"
        className="max-w-[1200px] mx-auto relative flex  items-start justify-start p-4 lg:p-0 bg-primary min-h-full"
      >
        <aside className="hidden lg:block w-72 sticky top-0  shrink-0 h-full">
          <div className="p-4 ">
        ...
        <main className="w-full lg:w-[calc(100%_-_288px)] h-full mx-auto mt-6 lg:px-4 ">
          <Section id="general">
            ...
            <div className="text-light  inline-block text-left mb-4">
              ...
              {myInfo.general.education.map((ed) => (
                <>
                  <p className="font-bold  text-lg text-accent">{ed.university}</p>
            ...
            <CustomCarousel
              ...
              className="mb-4"
              renderItem={(exp) => (
                <div className="flex w-full flex-col gap-2 bg-secondary rounded-md h-full w-1/ lg:min-w-[300px] p-8">
          ...
          <Section id="backend">
            ...
            <Caption>
              ...
              I bring a wealth of expertise to the development of robust and scalable APIs. With a
              focus on reliability and efficiency, I possess a deep understanding of the
...
const Heading = ({ children }) => {
  return (
    <h1 className="text-4xl  mb-4 md:text-5xl lg:mb-6 lg:text-[3rem]  font-normal text-txtPrimary">
      {children}
    </h1>
  );
};
...
const Title = ({ children }) => {
  return <h2 className="mb-4 text-txtPrimary text-2xl lg:text-3xl">{children}</h2>;
};
...
const ProjectItem = (p) => {
  return (
    <div className="flex h-full flex-col items-start bg-secondary  p-6 lg:p-8  mr-2">
