  ...
  return (
    <main className="w-full lg:w-[calc(100%_-_288px)] h-full mx-auto mt-6 lg:px-4 overflow-x-hidden">
      ...
      <Section id="frontend">
        ...
        <Caption>
          A frontend developer specializing in single page application frameworks, I bring a wealth
          of expertise to the development of dynamic, responsive web applications. With proficiency
          in frameworks such as React, Next or Svelte, I am able to create engaging user interfaces
          that provide an intuitive user experience and are optimized for performance.
        </Caption>
        <Title>Skills</Title>
        <Skills>
      ...
      <Section id="backend">
        ...
        <Caption>
          ...
          on reliability and efficiency, I possess a deep understanding of the technologies and best
          practices required to build high-quality backend systems.
        </Caption>
        <Title>Skills</Title>
        <Skills>
      ...
      <Section id="mobile">
        ...
        <Caption>
          ...
          high-quality applications that meet the needs of clients and end-users alike. With a deep
          understanding of mobile development best practices and a commitment to staying up-to-date
          with the latest industry trends, I am able to deliver cutting-edge solutions that exceed
          expectations.
        </Caption>
        <Title>Skills</Title>
        <Skills>
